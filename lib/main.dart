...
import 'package:foodninjabmsce/Restaurant/rsignup.dart';
import 'package:foodninjabmsce/Firstpage.dart';
import 'package:foodninjabmsce/Restaurant/rsign_in.dart';
import 'package:foodninjabmsce/loginpage/signin_page.dart';
import 'package:foodninjabmsce/loginpage/signup_page.dart';
import 'package:firebase_core/firebase_core.dart';
import 'package:foodninjabmsce/const/themecolor.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:foodninjabmsce/Restaurant/resthome.dart';
import 'package:foodninjabmsce/contactus.dart';
import 'package:foodninjabmsce/aboutus.dart';
import 'package:foodninjabmsce/Model/fooditem.dart';
import 'package:foodninjabmsce/Model/CartListBloc.dart';
import 'package:foodninjabmsce/Model/Provider.dart';
import 'package:bloc_pattern/bloc_pattern_test.dart';
import 'package:foodninjabmsce/Model/ListTileColorBloc.dart';
    ...
    return BlocProvider(
      ...
      child : MaterialApp(
        ...
        routes: <String, WidgetBuilder>{
          ...
          '/rsign_in': (BuildContext context) => new RestaurantLogin(),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          Icon(Icons.menu),
          StreamBuilder(
            stream: FirebaseFirestore.instance.collection('RestaurantData')
                .snapshots(),
            builder: (BuildContext context,
              ...
              return ListView(
                children: snapshot.data.docs.map((document) {
                  return Container(
                    child: Center(child: Text(document['restaurantName'])),
                  );
                }).toList(),
              );
            },
